...
elements.defaultCategory="slogan"
graphics.defaultCategory="ky"
   logos.defaultCategory="transp"

elements.Bclass="p2"
graphics.Bclass="p4"
   logos.Bclass="p1"

elements.getSource=function(a){
	return filePath+"e/"+a+".png"
}
graphics.getSource=function(a){
	return filePath+"g/"+a+(((window.devicePixelRatio||1)>1)?".png":"_500.png")
}
logos.getSource=function(a){
	return filePath+"l/"+a+".png"
}
