...
$traceurRuntime.toObject = function(value) {
  ...
  function m(a) {
    return "string" === typeof a ? e.document.createTextNode(a): a;
  }
  function h(a) {
    if (1 === a.length) return m(a[0]);
    for (var b = e.document.createDocumentFragment(),
        c = s.call(a),
        d = 0; d < a.length; d++) b.appendChild(m(c[d]));
    return b;
  }
  for (var n = Object.defineProperty || function(a, b, c) {
    a.__defineGetter__(b, c.get);
      ...
      q = /\s+/,
      r = function(a, b) {
        if (this.contains(a)) b || this.remove(a); else if (void 0 === b || b) b = !0, this.add(a);
        return !!b;
      },
      c = (e.Element || e.Node || e.HTMLElement).prototype,
      f = ["matches", c.matchesSelector || c.webkitMatchesSelector || c.khtmlMatchesSelector || c.mozMatchesSelector || c.msMatchesSelector || c.oMatchesSelector || function(a) {
        var b = this.parentNode;
        return !!b && - 1 < t.call(b.querySelectorAll(a), this);
      }, "prepend", function() {
        var a = this.firstChild,
            b = h(arguments);
        a ? this.insertBefore(b, a): this.appendChild(b);
      }, "append", function() {
        this.appendChild(h(arguments));
      }, "before", function() {
        var a = this.parentNode;
        a && a.insertBefore(h(arguments), this);
      }, "after", function() {
        var a = this.parentNode,
            b = this.nextSibling,
            c = h(arguments);
        a && (b ? a.insertBefore(c, b): a.appendChild(c));
      }, "replace", function() {
        var a = this.parentNode;
        a && a.replaceChild(h(arguments), this);
      }, "remove", function() {
        var a = this.parentNode;
        a && a.removeChild(this);
      }],
      s = f.slice,
      d = f.length; d; d -= 2) k = f[d - 2], k in c || (c[k] = f[d - 1]);
  "classList"in document.documentElement ? (g = document.createElement("div").classList, g.add("a", "b", "a"), "a b" != g && (c = g.constructor.prototype, "add"in c || (c = e.DOMTokenList.prototype), l = function(a) {
    return function() {
      for (var b = 0; b < arguments.length;) a.call(this, arguments[b++]);
    };
  }, c.add = l(c.add), c.remove = l(c.remove), c.toggle = r)): (l = function(a) {
    if (!a) throw "SyntaxError";
    if (q.test(a)) throw "InvalidCharacterError";
    return a;
  }, g = function(a) {
    var b = a.className.replace(u, "");
    b.length && f.push.apply(this, b.split(q));
    this._ = a;
  }, g.prototype = {
    length: 0,
    add: function() {
      for (var a = 0,
          b; a < arguments.length; a++) b = arguments[a], this.contains(b) || f.push.call(this, k);
    ...
    remove: function() {
      for (var a = 0,
          b; a < arguments.length; a++) b = arguments[a], this.contains(b) && f.splice.call(this, d, 1);
      this._.className = "" + this;
    },
    toggle: r,
    toString: function() {
      return f.join.call(this, " ");
    }
  }, n(c, "classList", {
    get: function() {
      return new g(this);
  ...
  "head"in document || n(document, "head", {get: function() {
      return p || (p = document.getElementsByTagName("head")[0]);
    }});
  try {
    new e.CustomEvent("?");
  } catch (v) {
    e.CustomEvent = function(a, b) {
      function c(a, b, d, e) {
        this.initEvent(a, b, d);
        this.detail = e;
      }
      return function(d, e) {
        var f = document.createEvent(a);
        if ("string" != typeof d) throw Error("An event name must be provided");
        "Event" == a && (f.initCustomEvent = c);
        null == e && (e = b);
        f.initCustomEvent(d, e.bubbles, e.cancelable, e.detail);
        return f;
      };
