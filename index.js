...
if(!ie){
	document.getElementById("fo").onsubmit=function(){displayresults();return false};

	textbox.oninput=function(){displayresults();localStorage.setItem("tb", textbox.value);};
