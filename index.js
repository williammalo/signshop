  ...
  addMethods(Element, {
    on: function() {
      ...
      for (var a = [],
        ...
        a[$__1] = arguments[$__1];
      ($__7 = this).addEventListener.apply($__7, $traceurRuntime.spread(a));
      return this;
    },
    clear: function() {
      var i;
...
(function() {
  ...
  WS.search = function() {
    ...
    var $__2 = args,
        keyword = ($__3 = $__2.keyword) === void 0 ? WS.inputElement.value : $__3,
        reverse = $__2.reverse,
        $__4 = WS.search,
        onappendnode = ($__5 = $__4.onappendnode) === void 0 ? noop : $__5,
        onfragmentpopulated = ($__6 = $__4.onfragmentpopulated) === void 0 ? noop : $__6,
...
WS.data.forEach(function(item) {
  var $__4,
      ...
      $__5;
  var $__2 = item,
      rawURL = ($__4 = $__2[$traceurRuntime.toProperty(Symbol.iterator)](), ($__3 = $__4.next()).done ? void 0 : $__3.value),
      rawText = ($__3 = $__4.next()).done ? void 0 : $__3.value,
      tags = ($__5 = ($__3 = $__4.next()).done ? void 0 : $__3.value) === void 0 ? "" : $__5,
      height = ($__3 = $__4.next()).done ? void 0 : $__3.value,
      sku = ($__3 = $__4.next()).done ? void 0 : $__3.value,
