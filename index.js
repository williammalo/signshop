...
views = mapObject(views, (function(a, b) {
  ...
  a.forEach((function(i) {
    i[2] = f(i[1]);
    i[3] = linkTemplate(a.buyPath + i[0] + a.buySuffix, i[2]);
