...
(function() {
  ...
  limitedFilter = (function(array, callback, limit) {
    var result = [];
    var index = - 1,
        length = array.length,
        value,
