...
WS.filter = function(array, callback) {
  ...
  while (++index < length) {
    value = array[index];
    if ((resultLength < WS.area) && callback(value, index, array)) {
...
WS.match = (function(keyword, target) {
...
WS.getResults = (function(keyword, reverse) {
  return WS.filter(WS.data, (function(i) {
    return WS.match(keyword, i.searchText)^reverse;
  }));
});
WS.search = function() {
