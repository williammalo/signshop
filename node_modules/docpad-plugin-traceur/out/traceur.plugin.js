  ...
  module.exports = function(BasePlugin) {
    ...
    return TraceurPlugin = (function(_super) {
      ...
      TraceurPlugin.prototype.render = function(opts) {
        var basePath, compiledTree, errReporter, file, filename, inExtension, key, literate, outExtension, srcFile, value, _ref1;
        ...
        if ((inExtension === 'traceur' || inExtension === 'tr') && (outExtension === 'js' || outExtension === null)) {
          ...
          _ref1 = this.config.featureOptions;
          for (key in _ref1) {
          ...
          if (!errReporter.hadError()) {
            opts.content = TreeWriter.write(compiledTree, {
